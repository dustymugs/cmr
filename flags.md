...
data/cub.py | cub_cache_dir | osp.join(cache_path, cub) | CUB Cache Directory
...
nnutils/train_utils.py | checkpoint_dir | osp.join(cache_path, snapshots) |
...
nnutils/test_utils.py | name | exp_name | Experiment Name
nnutils/test_utils.py | cache_dir | cache_path | Cachedir
nnutils/test_utils.py | gpu_id | 0 | Which gpu to use
nnutils/test_utils.py | batch_size | 4 | Size of minibatches
nnutils/test_utils.py | num_train_epoch | 0 | Number of training iterations
nnutils/test_utils.py | checkpoint_dir |
nnutils/test_utils.py | results_dir_base |
nnutils/test_utils.py | results_dir |  | This gets set automatically now
nnutils/test_utils.py | max_eval_iter | 0 |
nnutils/test_utils.py | save_visuals | False |
nnutils/test_utils.py | visuals_freq | 50 |
nnutils/test_utils.py | results_vis_dir |
nnutils/test_utils.py | results_eval_dir |
